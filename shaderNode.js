...
/**
 * Shader principal de galaxia espiral:
 * estrellas titilantes, brazos espirales y núcleo brillante.
 */
export const main = Fn(() => {
    ...
    const armMask = smoothstep(-0.2, 0.5, spiral)
        .mul(smoothstep(1.0, 0.2, spiral)).toVar();
